...
### Released
- Shipped **miz-otel-pack** as a public artifact for teams dealing with event-driven revenue systems.
...
### Shipped
- Cut the first coherent internal version of **miz-otel-pack** with stable domain objects, review surfaces, and decision outputs.
